...
config_description = {'upper': 'DEFAULT', 'lower': 'groups', 'srcline': 246, 'name': 'Default', 'parent': 0, 'srcfile': '/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py', 'cstate': 'true', 'parentname': 'Default', 'class': 'DEFAULT', 'field': 'default', 'state': True, 'parentclass': '', 'groups': [], 'parameters': [{'srcline': 291, 'description': 'Compression format', 'max': '', 'cconsttype': 'const char * const', 'ctype': 'std::string', 'srcfile': '/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py', 'name': 'format', 'edit_method': "{'enum_description': 'Enum to set the compression format', 'enum': [{'srcline': 9, 'description': 'PNG lossless compression', 'srcfile': '/home/ubuntu/Agroscope/ASPEN/Software/ROS/src/image_transport_plugins/compressed_depth_image_transport/cfg/CompressedDepthPublisher.cfg', 'cconsttype': 'const char * const', 'value': 'png', 'ctype': 'std::string', 'type': 'str', 'name': 'png'}, {'srcline': 10, 'description': 'RVL lossless compression', 'srcfile': '/home/ubuntu/Agroscope/ASPEN/Software/ROS/src/image_transport_plugins/compressed_depth_image_transport/cfg/CompressedDepthPublisher.cfg', 'cconsttype': 'const char * const', 'value': 'rvl', 'ctype': 'std::string', 'type': 'str', 'name': 'rvl'}]}", 'default': 'rvl', 'level': 0, 'min': '', 'type': 'str'}, {'srcline': 291, 'description': 'Maximum depth value (meter) ', 'max': 100.0, 'cconsttype': 'const double', 'ctype': 'double', 'srcfile': '/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py', 'name': 'depth_max', 'edit_method': '', 'default': 10.0, 'level': 0, 'min': 1.0, 'type': 'double'}, {'srcline': 291, 'description': 'Depth value at which the sensor accuracy is 1 m (Kinect: >75)', 'max': 150.0, 'cconsttype': 'const double', 'ctype': 'double', 'srcfile': '/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py', 'name': 'depth_quantization', 'edit_method': '', 'default': 100.0, 'level': 0, 'min': 1.0, 'type': 'double'}, {'srcline': 291, 'description': 'PNG compression level', 'max': 9, 'cconsttype': 'const int', 'ctype': 'int', 'srcfile': '/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py', 'name': 'png_level', 'edit_method': '', 'default': 1, 'level': 0, 'min': 1, 'type': 'int'}], 'type': '', 'id': 0}
