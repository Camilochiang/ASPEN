...
if("TRUE" STREQUAL "TRUE")
  set(compressed_image_transport_SOURCE_PREFIX /home/ubuntu/Agroscope/ASPEN/Software/ROS/src/image_transport_plugins/compressed_image_transport)
  set(compressed_image_transport_DEVEL_PREFIX /home/ubuntu/Agroscope/ASPEN/Software/ROS/devel)
  ...
  set(compressed_image_transport_INSTALL_PREFIX /home/ubuntu/Agroscope/ASPEN/Software/ROS/install)
...
if(NOT "/home/ubuntu/Agroscope/ASPEN/Software/ROS/devel/include;/home/ubuntu/Agroscope/ASPEN/Software/ROS/src/image_transport_plugins/compressed_image_transport/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(compressed_image_transport_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/Agroscope/ASPEN/Software/ROS/devel/include;/home/ubuntu/Agroscope/ASPEN/Software/ROS/src/image_transport_plugins/compressed_image_transport/include;/usr/local/include;/usr/local/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'compressed_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Agroscope/ASPEN/Software/ROS/src/image_transport_plugins/compressed_image_transport/${idir}'.  ${_report}")
    endif()
    _list_append_unique(compressed_image_transport_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "compressed_image_transport;/usr/local/lib/libopencv_calib3d.so.3.4.16;/usr/local/lib/libopencv_core.so.3.4.16;/usr/local/lib/libopencv_dnn.so.3.4.16;/usr/local/lib/libopencv_features2d.so.3.4.16;/usr/local/lib/libopencv_flann.so.3.4.16;/usr/local/lib/libopencv_highgui.so.3.4.16;/usr/local/lib/libopencv_imgcodecs.so.3.4.16;/usr/local/lib/libopencv_imgproc.so.3.4.16;/usr/local/lib/libopencv_ml.so.3.4.16;/usr/local/lib/libopencv_objdetect.so.3.4.16;/usr/local/lib/libopencv_photo.so.3.4.16;/usr/local/lib/libopencv_shape.so.3.4.16;/usr/local/lib/libopencv_stitching.so.3.4.16;/usr/local/lib/libopencv_superres.so.3.4.16;/usr/local/lib/libopencv_video.so.3.4.16;/usr/local/lib/libopencv_videoio.so.3.4.16;/usr/local/lib/libopencv_videostab.so.3.4.16;/usr/local/lib/libopencv_viz.so.3.4.16")
